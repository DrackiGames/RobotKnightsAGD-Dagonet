...
public class CourtyardOfficeDoorInteractionEvent : InteractionEvent
{
	public Transform officeEntryPointLocation;
	...
	public override IEnumerator interactionEvents()
	{
		...
		GameObject.FindGameObjectWithTag("MainCharacter").GetComponent<NavMeshAgent>().Warp(officeEntryPointLocation.position);
